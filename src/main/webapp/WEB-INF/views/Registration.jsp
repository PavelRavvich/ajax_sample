...
<head>
    ...
    <%--JavaScript refer --%>
    <script><%@include file="/WEB-INF/views/js/validation_input.js" %></script>
    <script><%@include file="/WEB-INF/views/js/update_location.js" %></script>
    ...
    <div class="row">
        <div class="col-md-offset-3 col-md-6">
            ...
            <form class="form-horizontal" role="form" id="commentForm"
                  method="post" action="" name="add_data">
